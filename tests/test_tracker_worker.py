...
# def test_add_expense(mock_input: MagicMock,
#                      mock_get_amount_from_user: MagicMock, mock_tracker: Tracker) -> None:
...
# def test_change_budget(mock_tracker: Tracker) -> None:
#     tracker_worker = TrackerWorker(mock_tracker)
#     tracker_worker.change_budget()

#     assert mock_tracker.budget == 100.0

# @patch('src.tracker_worker.get_date_from_user',
#        side_effect=[datetime(2024, 1, 1), datetime(2024, 12, 31)])
# def test_view_sublist(mock_tracker: Tracker) -> None:
#     mock_tracker.sublist = MagicMock(return_value=[
#                            Expense(10.0, 'category',
#                            'expense description', datetime(2024, 2, 10))])
